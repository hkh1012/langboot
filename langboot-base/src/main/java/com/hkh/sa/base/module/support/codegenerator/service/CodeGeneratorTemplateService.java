...
import com.hkh.sa.base.module.support.codegenerator.service.variable.backend.*;
import com.hkh.sa.base.module.support.codegenerator.service.variable.backend.domain.*;
import com.hkh.sa.base.module.support.codegenerator.service.variable.front.ApiVariableService;
import com.hkh.sa.base.module.support.codegenerator.service.variable.front.ConstVariableService;
import com.hkh.sa.base.module.support.codegenerator.service.variable.front.FormVariableService;
import com.hkh.sa.base.module.support.codegenerator.service.variable.front.ListVariableService;
import com.hkh.sa.base.module.support.codegenerator.util.CodeGeneratorTool;
...
public class CodeGeneratorTemplateService {
    ...
    public String generate(String tableName, String file, CodeGeneratorConfigEntity codeGeneratorConfigEntity) {
        ...
        //主键字段名称和java类型
        CodeField primaryKeycodeField = null;
        for (CodeField codeField : fields){
            if (codeField.getPrimaryKeyFlag() != null) {
                primaryKeycodeField = codeField;
                break;
            }
        }
