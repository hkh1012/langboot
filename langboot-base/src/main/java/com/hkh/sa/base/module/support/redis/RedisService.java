package com.hkh.sa.base.module.support.redis;

import com.alibaba.fastjson2.JSONObject;
import com.hkh.domain.common.SystemEnvironment;
import com.hkh.domain.enums.base.SystemEnvironmentEnum;
...
public class RedisService {
    ...
    public <T> T getObject(String key, Class<T> clazz) {
        ...
        T obj = JSONObject.parseObject(json.toString(), clazz);
        return obj;
    }
