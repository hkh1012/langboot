package com.hkh.sa.base.module.support.config.service;
...
import com.hkh.domain.form.config.ConfigAddForm;
import com.hkh.domain.form.config.ConfigQueryForm;
import com.hkh.domain.form.config.ConfigUpdateForm;
import com.hkh.domain.vo.config.ConfigVO;
import com.hkh.domain.enums.ConfigKeyEnum;
import com.hkh.domain.constant.ReloadConst;
import com.hkh.sa.base.common.util.SmartBeanUtil;
import com.hkh.sa.base.common.util.SmartPageUtil;
import com.hkh.sa.base.module.support.config.dao.ConfigDao;
import com.hkh.sa.base.module.support.reload.core.annoation.SmartReload;
...
public class ConfigService {
    ...
    public <T> T getConfigValue2Obj(ConfigKeyEnum configKey, Class<T> clazz) {
        ...
        return JSONObject.parseObject(configValue, clazz);
    }
