package com.hkh.sa.base.module.support.codegenerator.service.variable.backend.domain;
...
import com.hkh.domain.dto.CodeInsertAndUpdate;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getEnumName())) {
                packageList.add("import com.hkh.domain.annotation.SchemaEnum;");
                packageList.add("import com.hkh.domain.enums.base.CheckEnum;");
                ...
                String checkEnum = checkEnumPrefix + (Boolean.TRUE.equals(field.getRequiredFlag())? ", required = true)" : ")");
                ...
                String apiModelProperty = prefix + (Boolean.TRUE.equals(field.getRequiredFlag()) ? ", requiredMode = Schema.RequiredMode.REQUIRED)" : ")");
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getDict())) {
                ...
                packageList.add("import com.hkh.sa.base.common.json.deserializer.DictDataDeserializer;");
            }
            ...
            if (CodeFrontComponentEnum.FILE_UPLOAD.equalsValue(field.getFrontComponent())) {
                ...
                packageList.add("import com.fasterxml.jackson.databind.annotation.JsonDeserialize;");
                packageList.add("import com.hkh.sa.base.common.json.deserializer.FileKeyVoDeserializer;");
            }
