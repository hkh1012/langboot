package com.hkh.sa.base.module.support.codegenerator.controller;
...
import com.hkh.sa.base.module.support.codegenerator.service.CodeGeneratorService;
...
public class CodeGeneratorController extends SupportBaseController {
    ...
    @ResponseBody
    public ResponseDTO<List<TableColumnVO>> getTableColumns(@PathVariable("table") String table) {
    ...
    @ResponseBody
    public ResponseDTO<TableConfigVO> getTableConfig(@PathVariable("table") String table) {
    ...
    public void download(@PathVariable("tableName") String tableName, HttpServletResponse response) throws IOException {
