...
import com.hkh.domain.entity.FileEntity;
...
import com.hkh.sa.base.module.support.securityprotect.service.SecurityFileService;
...
public class FileService {
    ...
    public ResponseDTO<FileUploadVO> fileUpload(MultipartFile file, Integer folderType, RequestUser requestUser) {
        ...
        fileEntity.setUuid(uploadVO.getUuid());
        fileEntity.setHttpUrl(uploadVO.getHttpUrl());
