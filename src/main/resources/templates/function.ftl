...
<main class="container" style="margin-top: 100px;">
    <form>
        <div class="form-group">
            <textarea class="form-control" onchange="contentChange();" maxlength="3000" id="functionContent" rows="9" aria-describedby="securityHelp" placeholder="请输入查询天气文本（限3000字）" required></textarea>
