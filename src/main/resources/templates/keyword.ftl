...
<head>
    ...
    <link href="/static/css/keyword.css" rel="stylesheet"/>
...
<main class="container" style="margin-top: 100px;">
    <form>
        <div class="form-group">
            <textarea class="form-control" onchange="contentChange();" maxlength="3000" id="keywordContent" rows="9" aria-describedby="keywordHelp" placeholder="请输入待提取关键词文本（限3000字）" required></textarea>
            <small id="keywordHelp" class="form-text text-danger"></small>
        </div>
        <div class="form-group">
            <div class="row">
                <div class="col">
                    <input type="text" id="keywordArea" class="form-control" placeholder="关键词所属领域,如'医学、法律等'" maxlength="20">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <div class="col">
                    <input type="text" id="keywordNum" class="form-control" placeholder="关键词数量，建议3~5个">
                </div>
            </div>
        </div>
        <button type="button" class="btn btn-success btn-round" id="genKeywordsBtn" onclick="genKeywords();">提取关键词</button>
        <div class="keywordResult" id="keywordResult"></div>
    </form>
</main>
