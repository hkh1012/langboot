...
<main class="container" style="margin-top: 100px;">
    <form>
        <div class="form-group">
            <textarea class="form-control" onchange="contentChange();" maxlength="3000" id="translateContent" rows="9" aria-describedby="translateHelp" placeholder="请输入需要翻译的文本（限3000字）" required></textarea>
            <small id="translateHelp" class="form-text text-danger"></small>
        </div>
        <div class="form-group">
            <div class="row">
                <div class="col">
                    <select id="targetLanguage" class="form-control custom-select" placeholder="选择目标语言'">
        ...
        <button type="button" class="btn btn-success btn-round" id="translateBtn" onclick="beginTranslate();">开始翻译</button>
        <div class="translateResult" id="translateResult"></div>
    </form>
</main>
