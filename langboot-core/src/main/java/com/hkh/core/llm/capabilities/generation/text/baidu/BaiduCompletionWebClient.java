...
@Slf4j
@Component
public class BaiduCompletionWebClient {
    ...
    public Flux<JSONObject> createFlux(JSONObject requestBody, BaiduBizProcessor baiduBizProcessor){
        ...
        flux.subscribe(
                jsonObject -> {
                    ...
                    stringFlux.subscribe(baiduBizProcessor::bizProcess);
                },
                System.err::println,
