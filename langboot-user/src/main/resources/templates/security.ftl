...
<main class="container" style="margin-top: 100px;">
    <form>
        <div class="form-group">
            <textarea class="form-control" onchange="contentChange();" maxlength="3000" id="securityContent" rows="9" aria-describedby="securityHelp" placeholder="请输入待安全检测文本（限3000字）" required></textarea>
            <small id="securityHelp" class="form-text text-danger"></small>
        </div>
        <button type="button" class="btn btn-success btn-round" id="securityBtn" onclick="securityCheck();">内容检测</button>
        <div class="securityResult" id="securityResult"></div>
    </form>
</main>
