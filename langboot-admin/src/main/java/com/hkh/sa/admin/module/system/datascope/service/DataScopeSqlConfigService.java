package com.hkh.sa.admin.module.system.datascope.service;

import com.hkh.sa.admin.AdminApplication;
import com.hkh.domain.annotation.DataScope;
import com.hkh.domain.enums.DataScopeTypeEnum;
import com.hkh.domain.enums.DataScopeViewTypeEnum;
import com.hkh.domain.enums.DataScopeWhereInTypeEnum;
import com.hkh.domain.vo.datascope.DataScopeSqlConfig;
import com.hkh.domain.strategy.AbstractDataScopeStrategy;
...
public class DataScopeSqlConfigService {
    ...
    private Map<String, DataScopeSqlConfig> refreshDataScopeMethodMap() {
        ...
        Arrays.stream(AdminApplication.COMPONENT_SCAN_PACKAGES).forEach(item -> urls.addAll(ClasspathHelper.forPackage(item)));
