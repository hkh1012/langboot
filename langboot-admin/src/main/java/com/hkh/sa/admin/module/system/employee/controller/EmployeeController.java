package com.hkh.sa.admin.module.system.employee.controller;
...
import com.hkh.sa.base.module.support.apiencrypt.annotation.ApiDecrypt;
...
public class EmployeeController {
    ...
    public ResponseDTO<String> updateDisableFlag(@PathVariable("employeeId") Long employeeId) {
    ...
    public ResponseDTO<String> resetPassword(@PathVariable("employeeId") Long employeeId) {
    ...
    public ResponseDTO<List<EmployeeVO>> getAllEmployeeByDepartmentId(@PathVariable("departmentId") Long departmentId) {
