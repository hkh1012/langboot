...
import com.hkh.sa.base.common.util.*;
...
public class EnterpriseController {
    ...
    public ResponseDTO<EnterpriseVO> getDetail(@PathVariable("enterpriseId") Long enterpriseId) {
    ...
    public ResponseDTO<String> deleteEnterprise(@PathVariable("enterpriseId") Long enterpriseId) {
